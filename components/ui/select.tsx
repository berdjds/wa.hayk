  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Clamp the popper to the available viewport rect: without max-h the
        // list grows past the frame (items become unselectable), and long
        // option labels push it off-screen horizontally.
        position === "popper" &&
